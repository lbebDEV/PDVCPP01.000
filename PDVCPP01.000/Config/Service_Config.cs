...
namespace PDVCPP01._000.Config
{
    class Service_Config
    {
        ...
        public static string NomeServico { get; set; } = "Pedidos Novos";

        public static string NomeCliente { get; set; } = "Copapa";
        ...
        public static bool CadastroHabilitado { get; set; }
        ...
        public static string DataRetrocesso { get; set; }
        ...
        public static bool CarregarConfiguracoes()
        {
            ...
            catch (Exception ex)
            {
                ...
                Guardian_Log.Log_Rotina(NomeServico, Tipo.Erro, "Erro ao executar a busca das configurações. " + ex.ToString());
            }
            return Status;
        }
